...
train_data_file = open('D:/V2 Python/c122/chat/Scripts/static/assets/chatbot_corpus/intents.json').read()
...
def preprocess_train_data():
    ...
    pickle.dump(stem_words, open('D:/V2 Python/c122/chat/Scripts/static/assets/chatbot_corpus/words.pkl','wb'))
    pickle.dump(tag_classes, open('D:/V2 Python/c122/chat/Scripts/static/assets/chatbot_corpus/classes.pkl','wb'))
